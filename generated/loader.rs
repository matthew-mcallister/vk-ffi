...
impl_table! {
    ...
    members: [
        ...
        {
            name: pfn_reset_query_pool_ext,
            method_name: reset_query_pool_ext,
            ptr: ResetQueryPoolEXT,
            signature: (
                query_pool: QueryPool,
                first_query: u32,
                query_count: u32,
        ...
        {
            name: pfn_cmd_draw_indirect_count_amd,
            method_name: cmd_draw_indirect_count_amd,
            ptr: CmdDrawIndirectCountAMD,
            signature: (
                command_buffer: CommandBuffer,
                buffer: Buffer,
                offset: DeviceSize,
        ...
        {
            name: pfn_cmd_draw_indexed_indirect_count_amd,
            method_name: cmd_draw_indexed_indirect_count_amd,
            ptr: CmdDrawIndexedIndirectCountAMD,
            signature: (
                command_buffer: CommandBuffer,
                buffer: Buffer,
                offset: DeviceSize,
        ...
        {
            name: pfn_create_render_pass_2_khr,
            method_name: create_render_pass_2_khr,
            ptr: CreateRenderPass2KHR,
            signature: (
        ...
        {
            name: pfn_cmd_begin_render_pass_2_khr,
            method_name: cmd_begin_render_pass_2_khr,
            ptr: CmdBeginRenderPass2KHR,
            signature: (
                command_buffer: CommandBuffer,
                p_render_pass_begin: *const RenderPassBeginInfo,
        ...
        {
            name: pfn_cmd_next_subpass_2_khr,
            method_name: cmd_next_subpass_2_khr,
            ptr: CmdNextSubpass2KHR,
            signature: (
                command_buffer: CommandBuffer,
                p_subpass_begin_info: *const SubpassBeginInfoKHR,
        ...
        {
            name: pfn_cmd_end_render_pass_2_khr,
            method_name: cmd_end_render_pass_2_khr,
            ptr: CmdEndRenderPass2KHR,
            signature: (
                command_buffer: CommandBuffer,
                p_subpass_end_info: *const SubpassEndInfoKHR,
            ),
        ...
        {
            name: pfn_cmd_draw_indirect_count_khr,
            method_name: cmd_draw_indirect_count_khr,
            ptr: CmdDrawIndirectCountKHR,
            signature: (
                command_buffer: CommandBuffer,
                buffer: Buffer,
                offset: DeviceSize,
        ...
        {
            name: pfn_cmd_draw_indexed_indirect_count_khr,
            method_name: cmd_draw_indexed_indirect_count_khr,
            ptr: CmdDrawIndexedIndirectCountKHR,
            signature: (
                command_buffer: CommandBuffer,
                buffer: Buffer,
                offset: DeviceSize,
        ...
        {
            name: pfn_get_buffer_device_address_ext,
            method_name: get_buffer_device_address_ext,
            ptr: GetBufferDeviceAddressEXT,
            signature: (
